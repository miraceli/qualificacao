...
$sql1 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 1 AND CodTipoAtend = 248
ORDER BY DataAtendimento;";

$sql2 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 1 AND CodTipoAtend = 192
ORDER BY DataAtendimento;";

$sql3 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 14 AND CodTipoAtend = 146
ORDER BY DataAtendimento;";

$sql4 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 11 AND CodTipoAtend = 73
ORDER BY DataAtendimento;";

$sql5 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 1 AND CodTipoAtend = 71
ORDER BY DataAtendimento;";

$sql6 = "SELECT NrAtendimento, CodImovel, DataAtendimento, CodUsuario, DescAtendimento FROM ImovelAtend
WHERE CodSitAtend = 1 AND CodTipoAtend = 71
ORDER BY DataAtendimento;";

$consulta1 = mysqli_query($conexao1, $sql1);
$consulta2 = mysqli_query($conexao2, $sql2);
$consulta3 = mysqli_query($conexao3, $sql3);
$consulta4 = mysqli_query($conexao4, $sql4);
$consulta5 = mysqli_query($conexao5, $sql5);
$consulta6 = mysqli_query($conexao6, $sql6);
